...
dataset = "Lakehouse Semantic Model" # Enter the name or ID of the semantic model
workspace = "Lakehouse" # Enter the workspace name or ID in which the semantic model exists
